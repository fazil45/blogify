        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-(--text-light) dark:text-(--text-dark) leading-relaxed mb-8">
              Blogify was created to give every voice a platform. Whether you're
              a seasoned journalist, a weekend hobbyist, or a curious thinker —
              our platform gives you the tools to share your story with the
              world. No complexity, just pure writing.
            </p>
            ...
            <ul className="space-y-3 mb-10">
              {benefits.map((benefit) => (
                <li
                  key={benefit}
                  className="flex items-center gap-3 text-sm text-(--text-light) dark:text-(--text-dark)"
                >
