...
const VerifyEmailClient = () => {
  ...
  const verifyActionButton = () => {
    switch (status) {
      ...
      case "loading":
        return (
          <button className="w-full flex items-center justify-center gap-2 bg-yellow-200 text-black py-2.5 rounded-lg font-medium hover:bg-zinc-200 transition cursor-none">
      ...
      case "success":
        return (
          <button className="w-full flex items-center justify-center gap-2 bg-green-300 text-black py-2.5 rounded-lg font-medium hover:bg-zinc-200 transition cursor-none">
      ...
      case "error":
        return (
          <button className="w-full flex items-center justify-center gap-2 bg-red-300 text-black py-2.5 rounded-lg font-medium hover:bg-zinc-200 transition cursor-none">
    ...
    <div className="min-h-screen flex items-center justify-center bg-black text-white">
      ...
      >
        ...
        <span
          ...
          className="text-blue-300 text-md flex items-center justify-center cursor-pointer"
        >
